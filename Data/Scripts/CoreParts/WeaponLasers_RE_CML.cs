...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Imperial_Turrets_RecessedEmplacement_CML => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_SW_IMP_RecessedEmplacement_CML", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "REDCML_Ele", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "REDCML_Rot", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "REDCML_Ele",// Your Elevating Subpart, that bit that moves up.
                ...
                Muzzles = new[] {
                  ...
                  "muzzle_REDCML_10",
                  "muzzle_REDCML_11",
                  "muzzle_REDCML_12", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
            ...
            {
                PartName = "Recessed Emplacement Turret (Anti-Air Concussion Launcher)", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    ShotsInBurst = 46, // Use this if you don't want the weapon to fire an entire physical magazine in one go. Should not be more than your magazine capacity.
                    DelayAfterBurst = 1200, // How long to spend "reloading" after each burst. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
            ...
            Ammos = new[] {
                ALaser3kMedGreen, // Must list all primary, shrapnel, and pattern ammos.
            },
