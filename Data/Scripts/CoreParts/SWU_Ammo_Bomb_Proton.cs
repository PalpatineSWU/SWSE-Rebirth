...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef SWU_Bomb_Basic_ProtonBomb_I => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Proton Bomb I", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                GravityMultiplier = 1.5f, // Gravity multiplier, influences the trajectory of the projectile, value greater than 0 to enable. Natural Gravity Only.
                ...
                Smarts = new SmartsDef
                {
                    ...
                    MaxLateralThrust = 0.75, // controls how sharp the trajectile may turn
            ...
            {
                ModelName = "\\Models\\Ammo\\K_TIE_Bomber_Bomb_Small", // Model Path goes here.  "\\Models\\Ammo\\Starcore_Arrow_Missile_Large"
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 04f, //
                        Width = 0.1f, //
                        Color = Color(red: 0, green: 2, blue: 22f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
