...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition SWU_ImperialWeapons_Turret_Turbolaser_I => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_SW_IMP_DefenseBattery_DTC", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "DTC_Ele", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "DTC_Rot", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "DTC_Ele",// Your Elevating Subpart, that bit that moves up
                ...
                Scope = "muzzle_DBTC_01", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            {
                PartName = "Dual Turbolaser", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                SWU_Turbolaser_Basic_Green, 
				SWU_Turbolaser_Basic_Red,
				SWU_Turbolaser_Basic_Blue,
