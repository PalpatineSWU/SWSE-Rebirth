...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef SWU_IonTorpedo_A => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Ion Torpedo", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            BackKickForce = 1200f, // Recoil. This is applied to the Parent Grid.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                Grids = new GridSizeDef
                {
                    ...
                    Small = 0.10f, // Multiplier for damage against small grids.
                },
                Armor = new ArmorDef
                {
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                Smarts = new SmartsDef
                {
                    ...
                    MaxLateralThrust = 0.95, // controls how sharp the trajectile may turn
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 15f, //
                        Width = 3f, //
                        Color = Color(red: 0, green: 15, blue: 32f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                    ...
                    Trail = new TrailDef
                    {
                       ...
                       Color = Color(red: 35, green: 35, blue: 1f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        Back = false,
                        CustomWidth = 1.5f,
