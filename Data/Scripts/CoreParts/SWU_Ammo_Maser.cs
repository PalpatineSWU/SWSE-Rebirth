...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef SWU_Maser_Light_5 => new AmmoDef // Light Laser Cannon Analog | 5 Magazine | High Impulse | Kinetic-Bolt
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "LMC", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            BackKickForce = 650f, // Recoil. This is applied to the Parent Grid.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 5f, //
                        Width = 1f, //
                        Color = Color(red: 0, green: 10, blue: 25f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
            ...
            AmmoAudio = new AmmoAudioDef
            {
                ...
                HitSound = "LaserCannon_Hit",
                ShieldHitSound = "Shield_Hit",
                PlayerHitSound = "",
                VoxelHitSound = "",
                FloatingHitSound = "",
                HitPlayChance = 0.5f,
