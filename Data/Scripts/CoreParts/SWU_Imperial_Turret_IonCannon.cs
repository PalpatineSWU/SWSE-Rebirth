...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition SWU_ImperialWeapons_Turret_IonCannon_I => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_SW_IMP_DefenseBattery_DIC", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "DIC_Ele", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "DIC_Rot", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "DIC_Ele",// Your Elevating Subpart, that bit that moves up
                ...
                Scope = "muzzle_DBIC_01", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            {
                PartName = "Dual Ion-Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                SWU_IonCannon_Heavy_I, 
				SWU_IonCannon_Heavy_I_Shrapnel,
