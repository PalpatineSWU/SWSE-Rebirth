...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition SWU_NeutralWeapons_Starviper_MassDriver_A => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_Pirates_StarViper_Weaponry_SlugThrower", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "StarViper_SlugThrower_ELE", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                ...
                Muzzles = new[] {
                    "muzzle_missile_003", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
					 "muzzle_missile_004", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
 
                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "muzzle_missile_003", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            {
                PartName = "Slug Thrower (SV)", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                {
                    RateOfFire = 110, // Set this to 3600 for beam weapons. This is how fast your Gun fires.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "Weapon_SlugThrower", // Audio for firing.
            ...
            Ammos = new[] {
                SWU_Ballistic_SlugThrower_Light_10, 
