...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition NewRepublic_EwingProtonLauncher => new WeaponDefinition
        {
            ...
            {
                PartName = "E-Wing Fixed Laser Double", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
