...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition NewRepublic_EwingRoofLaserCannon => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_NewRepublic_EWing_RoofGun", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "EWing_Roof_Barrel", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "EWing_Roof_Rot", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "EWing_Roof_Ele",// Your Elevating Subpart, that bit that moves up.
                        DurabilityMod = 0.25f, // GeneralDamageMultiplier, 0.25f = 25% damage taken.
                        IconName = "Laser turrets.dds" // Overlay for block inventory slots, like reactors, refineries, etc.
                    },        
                 },
                Muzzles = new[] {
                  "muzzle_EWing_Prot_01",
				  "muzzle_EWing_Prot_02", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "EWing_Roof_Ele", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            Ammos = new[] {
                ...
                Ammo_Me_Laser_Green,
                Ammo_Me_Laser_Blue,
                Ammo_Me_Laser_Purple,
                Ammo_Me_Laser_Yellow, // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = NewRepublic_EWing_RoofCannon_Animations,
