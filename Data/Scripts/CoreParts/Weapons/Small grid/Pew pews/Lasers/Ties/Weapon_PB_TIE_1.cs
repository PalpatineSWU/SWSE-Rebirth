...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition SWU_ImperialWeapons_TIE_FIGHTER_Cannons_A => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_Imperial_Reborn_TIE_Fighter_Weaponry", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "TIEEle_A", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "TIERot_A", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "TIEEle_A",// Your Elevating Subpart, that bit that moves up
					...
					new MountPointDef {
                        SubtypeId = "K_Imperial_Reborn_TIE_Oppressor_Weaponry", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "TIEEle_A", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "TIERot_A", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "TIEEle_A",// Your Elevating Subpart, that bit that moves up
					...
					new MountPointDef {
                        SubtypeId = "K_Imperial_Reborn_TIE_Hunter_Weaponry", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "TIEEle_A", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "TIERot_A", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "TIEEle_A",// Your Elevating Subpart, that bit that moves up
						...
						new MountPointDef {
                        SubtypeId = "K_Imperial_Reborn_TIE_Interceptor_Weaponry", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "TIEEle_A", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "TIERot_A", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "TIEEle_A",// Your Elevating Subpart, that bit that moves up
						...
						new MountPointDef {
                        SubtypeId = "K_Imperial_Reborn_TIE_Bomber_Weaponry", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "TIEEle_A", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "TIERot_A", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "TIEEle_A",// Your Elevating Subpart, that bit that moves up
						...
						new MountPointDef {
                        SubtypeId = "K_Imperial_Reborn_TIE_Avenger_Weaponry", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "TIEEle_A", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "TIERot_A", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "TIEEle_A",// Your Elevating Subpart, that bit that moves up
						...
						new MountPointDef {
                        SubtypeId = "K_Imperial_Reborn_FirstOrder_TIE_Fighter_Weaponry", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "TIEEle_A", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "TIERot_A", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "TIEEle_A",// Your Elevating Subpart, that bit that moves up
						...
						new MountPointDef {
                        SubtypeId = "K_Imperial_Reborn_TIE_Droid_Weaponry", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "TIE_Droid_A_E", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "TIE_Droid_A", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "TIE_Droid_A_E",// Your Elevating Subpart, that bit that moves up
                        DurabilityMod = 1f, // GeneralDamageMultiplier, 0.25f = 25% damage taken.
                        IconName = "Laser turrets.dds" // Overlay for block inventory slots, like reactors, refineries, etc.
                    },                    
            ...
            {
                Threats = new[] {
                    Grids, Characters, Projectiles, // Types of threat to engage: Grids, Projectiles, Characters, Meteors, Neutrals
                },
                SubSystems = new[] {
                ...
                MaximumDiameter = 500, // Maximum radius of threat to engage; 0 = unlimited.
            ...
            {
                PartName = "TIE Cannon Ring (A)", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    IdlePower = .01f, // Constant base power draw in MW.
                ...
                Other = new OtherDef
                {
                    ConstructPartCap = 10, // Maximum number of blocks with this weapon on a grid; 0 = unlimited.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "K_Imperial_TIE_Shot", // Audio for firing.
                    ...
                    FireSoundEndDelay = 90, // How long the firing audio should keep playing after firing stops. Measured in game ticks(6 = 100ms, 60 = 1 seconds, etc..).
                },
