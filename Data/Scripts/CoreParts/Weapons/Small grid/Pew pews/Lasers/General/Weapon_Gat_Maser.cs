...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition P_Wep_Gat_Maser_SG => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {                  
                    new MountPointDef {
                        SubtypeId = "SG_Mas_Gat_Main", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Laser Gat", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
