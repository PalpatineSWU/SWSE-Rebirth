...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition P_Wep_Gat_Slug_SG => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {                  
                    new MountPointDef {
                        SubtypeId = "SG_Lug_Gat_Main", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            Ammos = new[] {
                AutocannonShell_SW, // Must list all primary, shrapnel, and pattern ammos.
            },
