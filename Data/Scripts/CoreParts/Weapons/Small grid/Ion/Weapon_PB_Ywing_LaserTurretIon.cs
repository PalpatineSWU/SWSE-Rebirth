...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition NewRepublic_YWing_Turret_Ion => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_NewRepublic_YWing_IonTurret", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "YWINGTurretIon_Ele", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "YWINGTurretIon_Rot", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "YWINGTurretIon_Ele",// Your Elevating Subpart, that bit that moves up.
                ...
                Muzzles = new[] {
                  "muzzle_YIon_01",
				  "muzzle_YIon_02", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
            ...
            {
                PartName = "Y-Wing Laser", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
