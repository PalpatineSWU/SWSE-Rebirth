...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Rebellion_RZ1_LaserCannon_Ion => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_Rebellion_RZ1_LaserCannon_SuperchargerUpgrade", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "RZ1_LaserCannon_Super_Ele", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "RZ1_LaserCannon_Super_Rot", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "RZ1_LaserCannon_Super_Ele",// Your Elevating Subpart, that bit that moves up.
                        DurabilityMod = 0.25f, // GeneralDamageMultiplier, 0.25f = 25% damage taken.
                        IconName = "Ion turrets.dds" // Overlay for block inventory slots, like reactors, refineries, etc.
                    },               
                 },
                Muzzles = new[] {
                  "muzzle_RZ1_LaserCannonStock_01", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
            ...
            Ammos = new[] {
                Ammo_Sm_Ion_Teal, // Must list all primary, shrapnel, and pattern ammos.
            },
