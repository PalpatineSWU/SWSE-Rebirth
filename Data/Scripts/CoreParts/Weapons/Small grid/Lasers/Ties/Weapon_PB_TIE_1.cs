...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition SWU_ImperialWeapons_TIE_FIGHTER_Cannons_A => new WeaponDefinition
        {
            ...
            {
                PartName = "TIE Cannon (A)", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                {
                    RateOfFire = 225, // Set this to 3600 for beam weapons. This is how fast your Gun fires.
