...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Imperial_TIE_Defender_Launcher => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_Imperial_Reborn_TIE_Defender_BodyWeaponry", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                  "TIE_Defender_LauncherMuzzle_01",
				  "TIE_Defender_LauncherMuzzle_02",// Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
            ...
            {
                PartName = "Tie Defender Launcher", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
