...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Imperial_Weaponry_TIE_RebornHunter_BlasterTurret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_Imperial_Reborn_TIE_Hunter_CyclicRepeatingBlaster", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "HunterBlaster_Spinner", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "HunterBlaster_Spinner", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "HunterBlaster_Rot", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "HunterBlaster_Ele",// Your Elevating Subpart, that bit that moves up.
                        DurabilityMod = 0.25f, // GeneralDamageMultiplier, 0.25f = 25% damage taken.
                        IconName = "Laser turrets.dds" // Overlay for block inventory slots, like reactors, refineries, etc.
                    },             
                 },
                Muzzles = new[] {
                  "muzzle_HunterCylic_008",
				  "muzzle_HunterCylic_007",
				  "muzzle_HunterCylic_006",
				  "muzzle_HunterCylic_005",
				  "muzzle_HunterCylic_004",
				  "muzzle_HunterCylic_003",
				  "muzzle_HunterCylic_002",
				  "muzzle_HunterCylic_001", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
            ...
            {
                PartName = "Cyclic Repeating Blaster", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    MaxHeat = 24, // Max heat before weapon enters cooldown (70% of max heat).
                    ...
                    BarrelSpinRate = 64, // Visual only, 0 disables and uses RateOfFire.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "K_Imperial_LightLaserCannon", // Audio for firing.
