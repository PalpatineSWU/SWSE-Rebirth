...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition NewRepublic_YWing_Launcher => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_NewRepublic_YWing_TorpedoLauncher", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                  "muzzle_YWingTorp_01",
				  "muzzle_YWingTorp_02", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
