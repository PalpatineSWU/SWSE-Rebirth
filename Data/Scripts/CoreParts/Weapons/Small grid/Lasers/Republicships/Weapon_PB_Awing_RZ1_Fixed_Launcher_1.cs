...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Rebellion_RZ1_Launcher_Micro => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_Rebellion_RZ1_Launcher_MicroLaunchUpgrade", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                  "muzzle_AWing_Micro_01",
				  "muzzle_AWing_Micro_02", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
