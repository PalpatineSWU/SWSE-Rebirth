...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition NewRepublic_H60MediumLaserCannon => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_NewRepublic_H60_MediumLaserCannon", // Block Subtypeid. Your Cubeblocks contain this information
