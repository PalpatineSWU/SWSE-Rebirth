...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition NewRepublic_YWing_Turret_Laser => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_NewRepublic_YWing_LaserTurret", // Block Subtypeid. Your Cubeblocks contain this information
