...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition NewRepublic_EwingWingLaserCannonA => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_NewRepublic_EWing_WingGunA", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "EWing_Muzzle_I", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "EWing_LaserI_Rot", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "EWing_LaserI_Ele",// Your Elevating Subpart, that bit that moves up.
                        DurabilityMod = 0.25f, // GeneralDamageMultiplier, 0.25f = 25% damage taken.
                        IconName = "Laser turrets.dds" // Overlay for block inventory slots, like reactors, refineries, etc.
                    },        
                 },
                Muzzles = new[] {
                  "muzzle_missile_009", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "EWing_LaserI_Ele", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            {
                PartName = "E-Wing Laser", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "K_NR_LaserCannon_Heavy", // Audio for firing.
            ...
            Animations = NewRepublic_EWing_WingI_Animations,
