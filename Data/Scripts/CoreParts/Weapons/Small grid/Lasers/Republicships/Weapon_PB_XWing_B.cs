...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition K_NewRepublic_XWing70_Wing_B => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_NewRepublic_XWing_70_Weaponry_Wing_B", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "XWing_B_Ele", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "XWing_B_Rot", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "XWing_B_Ele",// Your Elevating Subpart, that bit that moves up.
            ...
            Animations = NewRepublic_XWing_B_Animations,
