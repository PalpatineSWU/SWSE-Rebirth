...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition NewRepublic_EwingProtonLauncher => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_NewRepublic_EWing_ProtonLauncher", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "E-Wing Launcher", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
