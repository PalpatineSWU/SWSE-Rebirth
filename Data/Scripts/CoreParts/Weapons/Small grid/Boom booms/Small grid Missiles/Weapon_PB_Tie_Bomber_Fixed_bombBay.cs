...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition SWU_ImperialWeapons_TIE_Bomber_BombBay_A => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_Imperial_Reborn_TIE_Bomber_BombBay", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                  "muzzle_Bomber_Bay_001",
				  "muzzle_Bomber_Bay_002",
				  "muzzle_Bomber_Bay_003",
                },
            ...
            {
                PartName = "Bomb Bay Launcher", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
