...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Imperial_Weaponry_TIE_RebornOppressor_HeavyLauncher => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_Imperial_Reborn_TIE_Oppressor_HeavyLauncher", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                  "muzzle_Oppressor_Missile_01",
				  "muzzle_Oppressor_Missile_02",
				  "muzzle_Oppressor_Missile_03",
				  "muzzle_Oppressor_Missile_04",
				  "muzzle_Oppressor_Missile_05",
				  "muzzle_Oppressor_Missile_06", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
            ...
            {
                PartName = "Tie Oppressor Launcher", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
