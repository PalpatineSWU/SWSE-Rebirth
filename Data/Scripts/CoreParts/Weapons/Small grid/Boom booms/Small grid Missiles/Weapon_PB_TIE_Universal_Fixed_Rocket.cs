...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition SWU_ImperialWeapons_Rocketpod => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_TIE_Attachable_RocketPod", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Attachable Pod Launcher", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
