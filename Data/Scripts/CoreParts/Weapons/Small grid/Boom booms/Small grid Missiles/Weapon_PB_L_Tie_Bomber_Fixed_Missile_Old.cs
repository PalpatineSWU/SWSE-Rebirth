...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Imperial_Weaponry_TIEBomber_Missile_Old => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_TIE_Bomber_Pod", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Launcher Bomber Pod", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
