...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition NewRepublic_Ionizer_LaserCannon => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_NewRepublic_Ionizer_LC", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "IonizerLC_Ele", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "IonizerLC_Rot", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "IonizerLC_Ele",// Your Elevating Subpart, that bit that moves up.
                ...
                Muzzles = new[] {
                  "muzzle_IonizerLC_01",
				  "muzzle_IonizerLC_02", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
            ...
            {
                PartName = "Ionizer Laser", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "K_NR_LaserCannon_Average", // Audio for firing.
