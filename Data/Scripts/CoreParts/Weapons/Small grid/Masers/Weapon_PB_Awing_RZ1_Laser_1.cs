...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Rebellion_RZ1_LaserCannon_Overcharge => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_Rebellion_RZ1_LaserCannon_OverchargeUpgrade", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "RZ1_LaserCannon_Over_Ele", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "RZ1_LaserCannon_Over_Rot", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "RZ1_LaserCannon_Over_Ele",// Your Elevating Subpart, that bit that moves up.
                        DurabilityMod = 0.25f, // GeneralDamageMultiplier, 0.25f = 25% damage taken.
                        IconName = "Maser turrets.dds" // Overlay for block inventory slots, like reactors, refineries, etc.
                    },             
                 },
                Muzzles = new[] {
                  "muzzle_RZ1_LaserCannonOver_01", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "RZ1_LaserCannon_Over_Ele", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            {
                PartName = "A-Wing RZ1 Laser", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    MaxHeat = 20, // Max heat before weapon enters cooldown (70% of max heat).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "K_REB_LaserCannon_Heavy", // Audio for firing.
            ...
            Ammos = new[] {
                ...
                Ammo_Sm_Maser_Green,
                Ammo_Sm_Maser_Blue,
                Ammo_Sm_Maser_Purple,
                Ammo_Sm_Maser_Yellow, // Must list all primary, shrapnel, and pattern ammos.
            },
            //Animations = NewRepublic_XWingXJ5_A_Animations,
