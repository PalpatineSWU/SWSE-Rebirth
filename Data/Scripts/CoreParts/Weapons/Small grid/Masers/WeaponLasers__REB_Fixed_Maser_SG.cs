...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Rebellion_FixedMount_LaserCannon_01 => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_Rebellion_FM_LaserCannon_01", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            HardPoint = new HardPointDef
            {
                ...
                {
                    RateOfFire = 65, // Set this to 3600 for beam weapons. This is how fast your Gun fires.
            ...
            Animations = REB_Animations_Recoil_FM_LC_01,
