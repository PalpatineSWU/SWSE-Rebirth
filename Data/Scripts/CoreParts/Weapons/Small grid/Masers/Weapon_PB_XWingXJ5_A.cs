...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition K_NewRepublic_XWingXJ5_Wing_A => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_NewRepublic_XWing_XJ5_Weaponry_Wing_A", // Block Subtypeid. Your Cubeblocks contain this information
                        ...
                        AzimuthPartId = "XWingXJ5_A_Rot", // Your Rotating Subpart, the bit that moves sideways.
