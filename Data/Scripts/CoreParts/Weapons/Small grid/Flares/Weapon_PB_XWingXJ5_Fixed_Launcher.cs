...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition K_NewRepublic_XWingXJ5_Launcher => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_NewRepublic_XWing_XJ5_Launcher", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                  "muzzle_XJ5_Launcher_01",
				  "muzzle_XJ5_Launcher_02",
				  "muzzle_XJ5_Launcher_03", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
            ...
            {
                PartName = "X-Wing Flare Launcher", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                ...
                Ammo_Flare_Blue,
                Ammo_Flare_Purple,
                Ammo_Flare_Yellow, // Must list all primary, shrapnel, and pattern ammos.
            },
