...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition K_NewRepublic_XWing70_Launcher => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_NewRepublic_XWing_70_ProtonTorpedoLauncher", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                  "muzzle_XWingLauncher_01",
				  "muzzle_XWingLauncher_02", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
            ...
            HardPoint = new HardPointDef
            {
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "K_NR_Torpedo_Launch", // Audio for firing.
            ...
            Animations = K_NewRepublic_XWing70_Launcher_Animations,
