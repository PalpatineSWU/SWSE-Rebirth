...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Imperial_Weaponry_TIE_RebornOppressor_BombBay => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_Imperial_Reborn_TIE_Oppressor_HeavyBay", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                  "muzzle_Oppressor_Bomb_01",
				  "muzzle_Oppressor_Bomb_02",
				  "muzzle_Oppressor_Bomb_03",
				  "muzzle_Oppressor_Bomb_04", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
