...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Imperial_TIE_Avenger_Launcher => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_Imperial_Reborn_TIE_Avenger_Launcher", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                  "muzzle_AvengerMissile_01",
				  "muzzle_AvengerMissile_02",
				  "muzzle_AvengerMissile_03",
				  "muzzle_AvengerMissile_04",
            ...
            {
                PartName = "Avenger Flare Launcher", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                {
                    RateOfFire = 45, // Set this to 3600 for beam weapons. This is how fast your Gun fires.
