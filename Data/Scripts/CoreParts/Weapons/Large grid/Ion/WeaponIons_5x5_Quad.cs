...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Imperial_Turrets_DefenseHeavyBattery_PTL => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_SW_IMP_DefenseHeavyBattery_PTL", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "HBPTL_Ele", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "HBPTL_Rot", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "HBPTL_Ele",// Your Elevating Subpart, that bit that moves up.
				...
				"muzzle_HBPTL_02",
				"muzzle_HBPTL_03",
				"muzzle_HBPTL_04", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
            ...
            {
                PartName = "Heavy Defense Battery Turret (Proton Torpedo Launcher)", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Other = new OtherDef
                {
                    ...
                    RestrictionRadius = 12, // Prevents other blocks of this type from being placed within this distance of the centre of the block.
                ...
                Loading = new LoadingDef
                {
                    ...
                    MaxHeat = 40, // Max heat before weapon enters cooldown (70% of max heat).
            ...
            Ammos = new[] {
                Ammo_La_Ion_Teal, // Must list all primary, shrapnel, and pattern ammos.
            },
