...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Rebellion_Hoth_LaserCannonTurret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_Rebellion_Hoth_LaserCannonTurret", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Small Ion Cannon  (1x1)", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
