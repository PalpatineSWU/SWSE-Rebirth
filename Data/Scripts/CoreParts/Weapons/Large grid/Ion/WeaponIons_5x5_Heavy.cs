...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Rebellion_General_IonCannonEmplacement => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_Rebellion_General_LIonCannonTurret", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "The LION (5x5)", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
