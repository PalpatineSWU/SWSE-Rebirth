...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Imperial_Turrets_DefenseBattery_HIC => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_SW_IMP_DefenseBattery_HIC", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "HIC_Ele", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "HIC_Rot", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "HIC_Ele",// Your Elevating Subpart, that bit that moves up.
                        DurabilityMod = 0.25f, // GeneralDamageMultiplier, 0.25f = 25% damage taken.
                        IconName = "Ion turrets.dds" // Overlay for block inventory slots, like reactors, refineries, etc.
                    },             
                 },
                Muzzles = new[] {
                  "muzzle_HIC_01", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
            ...
            {
                PartName = "Imperial Defense Battery Turret (Heavy Ion-Cannon) (3x3)", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "K_Imperial_IonCannon", // Audio for firing.
            ...
            Ammos = new[] {
                Ammo_Me_Ion_Teal, // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = AnimationMedium,
