...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Imperial_Turrets_DefenseBattery_HIC => new WeaponDefinition
        {
            ...
            {
                PartName = "Imperial Defense Battery Turret (Heavy Ion-Cannon)", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
