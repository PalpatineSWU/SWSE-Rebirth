...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Imperial_Turrets_Hangar => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {                  
                    new MountPointDef {
                        SubtypeId = "K_Imperial_Broadside_Body_ConcussionLauncher", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                  "muzzle_Concussion_01",
				  "muzzle_Concussion_02",
				  "muzzle_Concussion_03",
				  "muzzle_Concussion_04",
            ...
            {
                PartName = "Fightercraft Hangar", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    MaxActiveProjectiles = 4, // Maximum number of projectiles in flight
