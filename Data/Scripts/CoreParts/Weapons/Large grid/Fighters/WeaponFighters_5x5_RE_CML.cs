...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Imperial_Turrets_RecessedEmplacement_CML => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        ...
                        IconName = "Fighter turrets.dds" // Overlay for block inventory slots, like reactors, refineries, etc.
                    },             
                 },
                Muzzles = new[] {
                  "muzzle_REDCML_01",
            ...
            Ammos = new[] {
                Ammo_Sm_Laser_Red, // Must list all primary, shrapnel, and pattern ammos.
            },
