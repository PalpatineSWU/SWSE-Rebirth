...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition P_Wep_Gat_Laser_LG => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {                  
                    new MountPointDef {
                        SubtypeId = "LG_Las_Gat_Main", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "Las_Gat", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                ...
                Muzzles = new[] {
                  "muzzle_Las_Gat_1",
                  "muzzle_Las_Gat_2",
				  "muzzle_Las_Gat_3", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
            ...
            {
                PartName = "Laser Gat LG", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Other = new OtherDef
                {
                    ConstructPartCap = 7, // Maximum number of blocks with this weapon on a grid; 0 = unlimited.
                ...
                Loading = new LoadingDef
                {
                    ...
                    BarrelSpinRate = -32, // Visual only, 0 disables and uses RateOfFire.
