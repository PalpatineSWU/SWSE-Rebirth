...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Imperial_Turrets_RecessedEmplacement_DIC => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_SW_IMP_RecessedEmplacement_DIC", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "REDIC_Ele", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "REDIC_Rot", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "REDIC_Ele",// Your Elevating Subpart, that bit that moves up.
                ...
                Muzzles = new[] {
                  "muzzle_REDIC_01",
				  "muzzle_REDIC_02", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
