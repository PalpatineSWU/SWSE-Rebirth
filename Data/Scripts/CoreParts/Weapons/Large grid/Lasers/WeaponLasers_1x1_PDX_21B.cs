...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition NewRepublic_Turrets_MicroMissileLauncher => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_NewRepublic_Turrets_Light_NanoMissileTurret", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Nano Missile Launcher", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
