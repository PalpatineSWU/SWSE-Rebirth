...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Imperial_Turrets_LancerAA_TowerB => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        ...
                        AzimuthPartId = "LancerAA_B_Rot", // Your Rotating Subpart, the bit that moves sideways.
            ...
            {
                PartName = "Lancer (Slanted Tower Laser) (3x5)", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
