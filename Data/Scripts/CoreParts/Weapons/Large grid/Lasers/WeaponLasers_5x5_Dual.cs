...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Imperial_Turrets_DefenseHeavyBattery_DMDC => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_SW_IMP_DefenseHeavyBattery_DMDC", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "HBDMDC_Ele", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "HBDMDC_Rot", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "HBDMDC_Ele",// Your Elevating Subpart, that bit that moves up.
                ...
                Muzzles = new[] {
                  "muzzle_HBDMDC_01",
				  "muzzle_HBDMDC_02", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
            ...
            {
                PartName = "Defense Battery Turret (Dual Massdriver)", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "K_Imperial_HeavyLaserCannon", // Audio for firing.
            ...
            Ammos = new[] {
                ...
                Ammo_La_Laser_Green,
                Ammo_La_Laser_Blue,
                Ammo_La_Laser_Purple,
                Ammo_La_Laser_Yellow, // Must list all primary, shrapnel, and pattern ammos.
            },
