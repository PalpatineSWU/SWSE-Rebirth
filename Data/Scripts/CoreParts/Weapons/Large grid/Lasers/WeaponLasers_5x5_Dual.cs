...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Imperial_Turrets_DefenseHeavyBattery_DMDC => new WeaponDefinition
        {
            ...
            {
                PartName = "Defense Battery Turret (Dual Laser) (5x5)", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
