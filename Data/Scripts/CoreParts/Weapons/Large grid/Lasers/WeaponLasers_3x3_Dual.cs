...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Imperial_Turrets_DefenseBattery_DLC => new WeaponDefinition
        {
            ...
            {
                PartName = "Defense Battery Turret (Dual Laser-Cannon) (3x3)", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
