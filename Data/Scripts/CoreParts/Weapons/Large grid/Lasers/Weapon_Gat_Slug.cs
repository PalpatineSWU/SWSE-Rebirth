...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition P_Wep_Gat_Slug_LG => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {                  
                    new MountPointDef {
                        SubtypeId = "LG_Lug_Gat_Main", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            Ammos = new[] {
                AssaultCannonShell_SW, // Must list all primary, shrapnel, and pattern ammos.
            },
