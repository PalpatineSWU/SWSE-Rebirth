...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition NewRepublic_Turrets_ProtectorLaserCannon => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_NewRepublic_Turrets_Light_ProtectorLaserCannon", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Twin Laser Cannon (1x1)", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
