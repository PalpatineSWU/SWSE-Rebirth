...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Imperial_Turrets_LaserCannon_StandardMulti3x => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {                  
                    new MountPointDef {
                        SubtypeId = "K_Imperial_Tower_Heavy", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "HLC_Ele", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "HLC_Rot", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "HLC_Ele",// Your Elevating Subpart, that bit that moves up.
                ...
                Muzzles = new[] {
                    "muzzle_HLaserCannon_01",
                    "muzzle_HLaserCannon_02",
                    "muzzle_HLaserCannon_03",
                    "muzzle_HLaserCannon_04",
                    "muzzle_HLaserCannon_05",
                    "muzzle_HLaserCannon_06",
                    "muzzle_HLaserCannon_07",
                    "muzzle_HLaserCannon_08",
            ...
            {
                PartName = "Maser Cannon Array (3x3)", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    SkipBarrels = 1, // Number of muzzles to skip after each fire event.
                    ...
                    DelayAfterBurst = 300, // How long to spend "reloading" after each burst. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "K_Imperial_LaserCannon", // Audio for firing.
            ...
            Ammos = new[] {
                ...
                Ammo_Me_Maser_Green,
                Ammo_Me_Maser_Blue,
                Ammo_Me_Maser_Purple,
                Ammo_Me_Maser_Yellow, // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = Imperial_Turrets_LaserCannon_HeavyS_Animations,
