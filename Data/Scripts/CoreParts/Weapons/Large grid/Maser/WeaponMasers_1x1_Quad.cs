...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Rebellion_General_QuadLaserCannonTurret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_Rebellion_General_LaserCannonTurret", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Quad-Ball Maser (1x1)", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
