...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Imperial_Turrets_RecessedEmplacement_DTC => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_SW_IMP_RecessedEmplacement_DTC", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "REDTC_Ele", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "REDTC_Rot", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "REDTC_Ele",// Your Elevating Subpart, that bit that moves up.
                ...
                Muzzles = new[] {
                  "muzzle_REDTC_01",
				  "muzzle_REDTC_02", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
            ...
            {
                PartName = "Recessed Emplacement Turret (Dual M-Turbolaser-Cannon)", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                ...
                Ammo_La_Maser_Green,
                Ammo_La_Maser_Blue,
                Ammo_La_Maser_Purple,
                Ammo_La_Maser_Yellow, // Must list all primary, shrapnel, and pattern ammos.
            },
