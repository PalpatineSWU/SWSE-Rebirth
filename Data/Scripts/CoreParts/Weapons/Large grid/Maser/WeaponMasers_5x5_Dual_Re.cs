...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Imperial_Turrets_RecessedEmplacement_DTC => new WeaponDefinition
        {
            ...
            {
                PartName = "Recessed Emplacement Turret (Dual Maser-Cannon) (5x5)", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
