...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Imperial_Turrets_DefenseHeavyBattery_DTC => new WeaponDefinition
        {
            ...
            {
                PartName = "Heavy Defense Battery Turret (Dual Heavy Maser) (5x5)", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
