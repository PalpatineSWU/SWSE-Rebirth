...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Imperial_Turrets_ConcussionLauncher1x => new WeaponDefinition
        {
            ...
            {
                PartName = "Concussion Launcher (1x1)", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                Missile_small_concuss,
                Missile_small_Proton,
                Missile_small_Impulse, // Must list all primary, shrapnel, and pattern ammos.
            },
