    ...
    partial class Parts {
        ...
        WeaponDefinition Imperial_Turrets_DefenseHeavyBattery_HVC6 => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "P_Tractorbeam", // Block Subtypeid. Your Cubeblocks contain this information
                        ...
                        IconName = "EWAR.dds" // Overlay for block inventory slots, like reactors, refineries, etc.
                    },             
                 },
                Muzzles = new[] {
                  "HBHVC6_Ele", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
