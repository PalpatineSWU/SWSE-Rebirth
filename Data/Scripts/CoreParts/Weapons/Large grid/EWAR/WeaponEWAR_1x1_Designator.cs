...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition NewRepublic_Turrets_AMS => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_NewRepublic_Turrets_Light_AMS", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Anti-Missile Beam-Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
