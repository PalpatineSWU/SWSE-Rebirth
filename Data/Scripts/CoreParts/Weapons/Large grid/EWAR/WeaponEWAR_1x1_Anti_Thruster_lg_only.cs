...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Wep_AntiThruster_lg => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "AntiThruster_20k_lgONLY", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            Ammos = new[] {
                Ammo_AntiThruster, // Must list all primary, shrapnel, and pattern ammos.
            },
