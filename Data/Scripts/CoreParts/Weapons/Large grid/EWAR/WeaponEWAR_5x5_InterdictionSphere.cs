...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Wep_InterdictionSphere => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "InterdictionSphere", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Interdiction Sphere (5x5x5)", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    IdlePower = 1000f, // Constant base power draw in MW.
            ...
            Ammos = new[] {
                Ammo_Interdiction, // Must list all primary, shrapnel, and pattern ammos.
            },
