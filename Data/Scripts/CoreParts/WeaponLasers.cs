...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Imperial_Turrets_LaserCannon_Standard1x => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                ...
                Muzzles = new[] {
                    "muzzle_LaserCannon_01", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
