...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition SWU_ImperialWeapons_Turret_LaserCannon_I => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_SW_IMP_DefenseBattery_DLC", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "DLC_Ele", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "DLC_Rot", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "DLC_Ele",// Your Elevating Subpart, that bit that moves up
                ...
                Scope = "muzzle_DBLC_01", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            {
                PartName = "Dual Lasercannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "K_Imperial_TurboLaser", // Audio for firing.
            ...
            Ammos = new[] {
                SWU_LaserCannon_Heavy_Green_I, 
				SWU_LaserCannon_Heavy_Red_I,
				SWU_LaserCannon_Heavy_Blue_I,
