...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef SWU_Ballistic_SlugThrower_Light_10 => new AmmoDef // Slug Thrower | Light | 6 Magazine | 90% Pen | 75% Armor Debuff
        {
            AmmoMagazine = "Magazine_Slug_Magazine_Light_10", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Slug 10", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                Armor = new ArmorDef
                {
                    ...
                    Heavy = 0.10f, // Multiplier for damage against heavy armor.
                ...
                Shields = new ShieldDef
                {
                    ...
                    BypassModifier = 0.90f, // If greater than zero, the percentage of damage that will penetrate the shield.
                },
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 5f, //
                        Width = 0.2f, //
                        Color = Color(red: 45, green: 25, blue: 1f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
