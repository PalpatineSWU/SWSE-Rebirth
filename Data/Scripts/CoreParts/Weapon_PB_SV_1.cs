...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition SWU_NeutralWeapons_Starviper_LaserCannon_A => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_Pirates_StarViper_Weaponry_LaserCannon", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "StarViper_Cannon_ELE", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "StarViper_Cannon_ROT", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "StarViper_Cannon_ELE",// Your Elevating Subpart, that bit that moves up.
            ...
            {
                PartName = "Star Viper Laser", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                {
                    RateOfFire = 490, // Set this to 3600 for beam weapons. This is how fast your Gun fires.
