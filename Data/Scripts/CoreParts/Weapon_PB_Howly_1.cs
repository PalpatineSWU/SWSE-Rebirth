...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Imperial_Weaponry_Howler_Cannon_One => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_Imperial_HowlRunner_Weaponry_A", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "HowlRunnerCannon_A_Ele", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "HowlRunnerCannon_A_Rot", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "HowlRunnerCannon_A_Ele",// Your Elevating Subpart, that bit that moves up.
            ...
            {
                PartName = "Howlrunner Laser", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
