...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef ALaser3kMedGreen => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "3k Med Green", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                DesiredSpeed = 380, // voxel phasing if you go above 5100
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 5f, //
                        Width = 1f, //
                        Color = Color(red: 0, green: 2, blue: 0f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
            ...
            AmmoAudio = new AmmoAudioDef
            {
                ...
                ShotSound = "K_Imperial_HeavyLaserCannon",
                ShieldHitSound = "",
                PlayerHitSound = "",
                VoxelHitSound = "",
                FloatingHitSound = "",
