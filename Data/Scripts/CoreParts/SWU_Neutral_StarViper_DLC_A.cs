...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition SWU_NeutralWeapons_Starviper_LaserCannon_A => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        ...
                        MuzzlePartId = "StarViper_Cannon_ELE", // The subpart where your muzzle empties are located. This is often the elevation subpart.
            ...
            {
                PartName = "H Laser Cannon (SV)", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
