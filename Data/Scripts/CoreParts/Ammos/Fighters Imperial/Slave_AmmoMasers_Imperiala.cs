...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef Ammo_Sm_MaserImpNHP => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "3kMedMaserNHPIMP", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                Smarts = new SmartsDef
                {
                    ...
                    MaxChaseTime = 20, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 3f, //
                        Width = 0.1f, //
                        Color = Color(red: 80, green: 80, blue: 155f, alpha: 80), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 8, green: 8, blue: 105, alpha: 80),
                        Back = false,
                        CustomWidth = 0,
            ...
            AmmoAudio = new AmmoAudioDef
            {
                ...
                ShotSound = "K_NR_LaserCannon_Average",
                ShieldHitSound = "",
                PlayerHitSound = "",
                VoxelHitSound = "",
                FloatingHitSound = "",
