...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef Missile_Large_Proton => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Proton", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            {
                ModelName = "\\Models\\Ammo\\SG - Proton Torpedo", // Model Path goes here.  "\\Models\\Ammo\\Starcore_Arrow_Missile_Large"
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 3f, //
                        Width = 1f, //
                        Color = Color(red: 112, green: 36, blue: 75f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 0, green: 0, blue: 60, alpha: 1),
                        Back = false,
                        CustomWidth = 0,
