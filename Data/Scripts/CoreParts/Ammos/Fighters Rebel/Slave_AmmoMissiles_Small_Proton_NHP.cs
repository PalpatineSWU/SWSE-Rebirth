...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef Missile_small_Proton_NHP => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "ProtonNHP", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            {
                ModelName = "\\Models\\Ammo\\MissileProjectile_Small", // Model Path goes here.  "\\Models\\Ammo\\Starcore_Arrow_Missile_Large"
