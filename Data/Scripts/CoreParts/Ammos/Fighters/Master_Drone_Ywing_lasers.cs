...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef Drone_Ywing_lasers => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "3k Med Red", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            {
                AmmoRound = "3kMedGreenNHP", // AmmoRound field of the ammo to spawn.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxLifeTime = 6000, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..). time begins at 0 and time must EXCEED this value to trigger "time > maxValue". Please have a value for this, It stops Bad things.
                ...
                MaxTrajectory = 80000f, // Max Distance the projectile or beam can Travel.
                ...
                Smarts = new SmartsDef
                {
                    ...
                    MaxLateralThrust = 50, // controls how sharp the trajectile may turn
                    TrackingDelay = 10, // Measured in Shape diameter units traveled.
                    MaxChaseTime = 3500000, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
            ...
            {
                ModelName = "\\Models\\NewRepublic\\Y_Wing\\KNR_YWing_Small.mwm", // Model Path goes here.  "\\Models\\Ammo\\Starcore_Arrow_Missile_Large"
                ...
                Particles = new AmmoParticleDef
                {
                    ...
                    {
                        Name = "SW_Canister_Gas_CrystalMisting", //ShipWelderArc
