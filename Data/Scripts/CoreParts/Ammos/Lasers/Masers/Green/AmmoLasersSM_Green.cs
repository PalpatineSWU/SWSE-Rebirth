...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef Ammo_Sm_Maser_Green => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Green (Class III)", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 3f, //
                        Width = 0.1f, //
                        Color = Color(red: 80, green: 155, blue: 80f, alpha: 80), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 8, green: 105, blue: 8, alpha: 80),
                        Back = false,
                        CustomWidth = 0,
