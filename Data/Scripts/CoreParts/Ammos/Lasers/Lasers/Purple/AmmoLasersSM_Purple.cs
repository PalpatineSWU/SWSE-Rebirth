...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef Ammo_Sm_Laser_Purple => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 3f, //
                        Width = 0.1f, //
                        Color = Color(red: 18, green: 0, blue: 18f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 8, green: 0, blue: 8, alpha: 1),
                        Back = false,
                        CustomWidth = 0,
