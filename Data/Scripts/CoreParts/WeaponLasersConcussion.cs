...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Imperial_Turrets_ConcussionLauncher1x => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_Imperial_Tower_ConcussionMissile", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "Imp_ConcussionLauncher_Ele", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "Imp_ConcussionLauncher_Rot", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "Imp_ConcussionLauncher_Ele",// Your Elevating Subpart, that bit that moves up.
                        DurabilityMod = 0.25f, // GeneralDamageMultiplier, 0.25f = 25% damage taken.
                        IconName = "TestIcon.dds" // Overlay for block inventory slots, like reactors, refineries, etc.
                    },             
                 },
                Muzzles = new[] {
                    "IMP_Muzzle_Concussion1x_01",
                    "IMP_Muzzle_Concussion1x_02",
                    "IMP_Muzzle_Concussion1x_03",
                    "IMP_Muzzle_Concussion1x_04",
                    "IMP_Muzzle_Concussion1x_05",
                    "IMP_Muzzle_Concussion1x_06",
                    "IMP_Muzzle_Concussion1x_07",
                    "IMP_Muzzle_Concussion1x_08",
                    "IMP_Muzzle_Concussion1x_09",
                    "IMP_Muzzle_Concussion1x_10",
            ...
            {
                PartName = "Concussion Launcher", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                ALaser3kMedGreen,
                ALaser3kMedRed, // Must list all primary, shrapnel, and pattern ammos.
            },
