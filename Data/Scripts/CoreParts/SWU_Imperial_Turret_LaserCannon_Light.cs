...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition SWU_ImperialWeapons_Turret_LaserCannon_Basic => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_Imperial_Tower_LaserCannon_Basic", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "LaserCannon_Ele", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                ...
                Muzzles = new[] {
                     "muzzle_LaserCannon_01",
				    
 
                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "muzzle_LaserCannon_01", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            Targeting = new TargetingDef
            {
                Threats = new[] {
                    Grids, Characters, Projectiles, Neutrals, // Types of threat to engage: Grids, Projectiles, Characters, Meteors, Neutrals
                },
                SubSystems = new[] {
            ...
            {
                PartName = "Lasercannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    ReloadSound = "WeaponReload_Light_A", // Sound SubtypeID, for when your Weapon is in a reloading state
                    NoAmmoSound = "",
