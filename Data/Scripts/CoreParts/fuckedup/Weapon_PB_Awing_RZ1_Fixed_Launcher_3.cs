...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Rebellion_RZ1_Launcher_Specialist => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_Rebellion_RZ1_Launcher_SpecialistUpgrade", // Block Subtypeid. Your Cubeblocks contain this information
                    ...
                    new MountPointDef {
                        SubtypeId = "K_Rebellion_RZ1_Launcher_Stock", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "None", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "None", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "None",// Your Elevating Subpart, that bit that moves up.
                ...
                Muzzles = new[] {
                  "muzzle_AWing_Concus_01",
				  "muzzle_AWing_Concus_02", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
            ...
            {
                PartName = "A-Wing RZ1 Launcher", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "K_NR_Missile_Light_Tracking", // Audio for firing.
