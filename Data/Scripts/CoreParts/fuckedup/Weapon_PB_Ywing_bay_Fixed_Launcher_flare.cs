...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition NewRepublic_YWing_BombBay => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_NewRepublic_YWing_BombBay", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
				  ...
				  "muzzle_YWingBay_02",
				  "muzzle_YWingBay_03",
				  "muzzle_YWingBay_04", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
            ...
            {
                PartName = "Y-Wing Bomb Bay", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    Offset = Vector(x: 0, y: -20, z: 0), // Offsets the aiming/firing line of the weapon, in metres.
            ...
            Ammos = new[] {
                Ammo_Flare_Red, // Must list all primary, shrapnel, and pattern ammos.
            },
