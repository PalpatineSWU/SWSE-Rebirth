...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Rebellion_Underground_Turret_A => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_Rebellion_General_PopupTurret_1", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "REBPopupTurret_Ele", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "REBPopupTurret_Rot", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "REBPopupTurret_Ele",// Your Elevating Subpart, that bit that moves up.
            ...
            {
                PartName = "Double Laser Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "K_REB_LaserCannon_Light", // Audio for firing.
            ...
            Animations = Rebellion_Turrets_Underground_Animation_1,
