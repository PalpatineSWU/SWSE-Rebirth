...
{ // Don't edit above this line
    partial class Parts
    {
        private AnimationDef NewRepublic_EWing_RoofCannon_Animations => new AnimationDef
        {
            ...
            AnimationSets = new[]
            {
                ...
                {
                    SubpartId = Names("EWing_Roof_Barrel"),
                        ...
                        [TurnOn] = new[] //Firing, Reloading, etc, see Possible Events,  define a new[] for each
                            {
                                new RelMove
                                {
                                   ...
                                   LinearPoints = new[]
                                    {
                                        Transformation(0, 0, -1.55f), //linear movement
                                    },
