...
{ // Don't edit above this line
    partial class Parts
    {
        private AnimationDef Imperial_Turrets_LaserCannon_HeavyS_Animations => new AnimationDef
        {
            /*
            Emissives = new[]
            {
            ...
            */
            ...
            AnimationSets = new[]
            {
                ...
                {
                    SubpartId = Names("HLC_Barrel_I"),
                    BarrelId = "muzzle_HLaserCannon_01", //only used for firing, use "Any" for all muzzles
                    StartupFireDelay = 60,
                ...
                new PartAnimationSetDef()
                {
                    SubpartId = Names("HLC_Barrel_II"),
                    BarrelId = "muzzle_HLaserCannon_05", //only used for firing, use "Any" for all muzzles
                    StartupFireDelay = 60,
                    AnimationDelays = Delays(FiringDelay : 0, ReloadingDelay: 0, OverheatedDelay: 0, TrackingDelay: 0, LockedDelay: 0, OnDelay: 0, OffDelay: 0, BurstReloadDelay: 0, OutOfAmmoDelay: 0, PreFireDelay: 0, StopFiringDelay: 0, StopTrackingDelay:0, InitDelay:0),//Delay before animation starts
                    Reverse = Events(),
                    Loop = Events(),
