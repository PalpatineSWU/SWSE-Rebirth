...
{ // Don't edit above this line
    partial class Parts
    {
        private AnimationDef K_NewRepublic_XWing70_Launcher_Animations => new AnimationDef
        {
            /*
            Emissives = new[]
            {
            ...
            */
            ...
            AnimationSets = new[]
            {
                ...
                {
                    SubpartId = Names("XWing_Launcher_A"),
                    BarrelId = "muzzle_missile_005", //only used for firing, use "Any" for all muzzles
                    StartupFireDelay = 0,
                        ...
                        [Firing] = new[] //Firing, Reloading, etc, see Possible Events,  define a new[] for each
                            {
                                new RelMove
                                {
                                    ...
                                    Rotation = Transformation(0, 15, 0f), //degrees
                ...
                new PartAnimationSetDef()
                {
                    SubpartId = Names("XWing_Launcher_B"),
                    BarrelId = "muzzle_missile_006", //only used for firing, use "Any" for all muzzles
                    StartupFireDelay = 0,
                    AnimationDelays = Delays(FiringDelay : 0, ReloadingDelay: 0, OverheatedDelay: 0, TrackingDelay: 0, LockedDelay: 0, OnDelay: 0, OffDelay: 0, BurstReloadDelay: 0, OutOfAmmoDelay: 0, PreFireDelay: 0, StopFiringDelay: 0, StopTrackingDelay:0, InitDelay:0),//Delay before animation starts
                    Reverse = Events(),
                    Loop = Events(),
