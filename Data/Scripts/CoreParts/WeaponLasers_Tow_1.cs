...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Imperial_Turrets_LancerAA_TowerA => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_SW_IMP_LancerAA_A", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Lancer (Tower)", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
